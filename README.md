<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Saim%20Afzal&fontSize=60&fontColor=ffffff&fontAlignY=38&desc=Software%20Development%20Engineer&descSize=18&descAlignY=58&descColor=a78bfa&animation=fadeIn" width="100%"/>
</div>

<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&duration=3000&pause=800&color=A78BFA&center=true&vCenter=true&width=500&lines=Building+elegant+web+experiences;React+%26+Next.js+specialist;Exploring+the+frontiers+of+AI%2FML;Clean+code+%7C+Clean+UI+%7C+Clean+architecture" alt="Typing SVG" />
</div>
...
const saim = {
  ...
  focus    : ["Frontend Development", "AI / ML", "Clean Architecture"],
  stack    : ["React", "Next.js", "JavaScript", "Tailwind CSS"],
  learning : "Advanced React patterns & modern web engineering",
  collab   : "Open to frontend projects & AI-powered web apps",
  motto    : "Ship clean code. Build beautiful UIs. Never stop learning.",
};
```
...
<div align="center">
  <sub>✦ Open to exciting opportunities & collaborations ✦</sub>
</div>
